...
def test_write_pl_df_to_s3(file_type, pl_df_color_fixture):
...
@mock_aws
def test_write_pl_df_to_s3_bad_file_type(pl_df_color_fixture):
    s3_bucket = "test-bucket"
    s3_path = "test-path"
    file_type = "json"
...
@mock_aws
def test_write_pl_df_to_s3_aws_creds(pl_df_color_fixture):
...
@mock_aws
def test_write_pl_df_to_s3_aws_creds_missing_key(pl_df_color_fixture):
    s3_bucket = "test-json-bucket"
    s3_path = "test-path"
    file_type = "parquet"
    aws_creds = {
