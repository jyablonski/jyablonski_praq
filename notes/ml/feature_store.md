...
1. Online Store (Low Latency, Recent Data):
...
1. Snapshot: Airflow executes a Snowflake query to create a clone of your training table.
   ```sql
...
1. Train: Your container connects to Snowflake and reads `train_data_2023_10_27`.
1. Log to MLflow: Instead of logging a git hash of a file, you log the Table Name as a parameter.
   ```python
