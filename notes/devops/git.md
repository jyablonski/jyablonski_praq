...
- Enables solid CI best practice. You _want_ to commit your code changes and get a PR up to have the CI running as fast as possible so you can have confidence your proposed changes work as early in the process as you can.
