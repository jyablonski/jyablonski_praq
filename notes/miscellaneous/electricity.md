...
2. Home runs: Separate cables run from the breaker to each outlet
...
2. The device uses some of that electrical energy to do work (light, heat, compute, etc.)
3. Current returns through the neutral wire back to the panel
4. From the panel, it goes back through the neutral wire to the transformer
5. The transformer completes the circuit back to the power source
...
2. Stepped up for transmission
3. Stepped down at substations
4. Stepped down again at your transformer to split-phase 240V
5. Enters your panel via two hot wires + neutral
6. Individual breakers protect circuits throughout your home
7. Wiring runs from breakers to outlets
8. You plug in devices, which draw current based on their needs
9. Current flows back through neutral to complete the circuit
10. You're billed for kilowatt-hours (power × time)
